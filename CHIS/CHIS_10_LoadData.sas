...
/* LOAD & VALIDATE 2016 DATA */
LIBNAME CHIS2016 "&localRawDataPath.\CHIS\CHIS16_adult_sas\Data\";
%INCLUDE "&localRawDataPath.\CHIS\CHIS16_adult_sas\Data\ADULT_PROC_FORMAT.SAS";
ODS PDF FILE="&localProjectPath.CHIS\%SYSFUNC(DEQUOTE(&_CLIENTTASKLABEL))_PROC-CONTENTS-2016.pdf"
        AUTHOR="Matthew C. Vanderbilt"
    ...
    PROC CONTENTS DATA=CHIS2016.adult VARNUM;
        ...
        %INCLUDE "&localRawDataPath.\CHIS\CHIS16_adult_sas\Data\ADULT_FORMAT.SAS";
        %INCLUDE "&localRawDataPath.\CHIS\CHIS16_adult_sas\Data\ADULT_LABEL.SAS";
    RUN;
ODS PDF CLOSE;

/* LOAD & VALIDATE 2015 DATA */
...
ODS PDF FILE="&localProjectPath.CHIS\%SYSFUNC(DEQUOTE(&_CLIENTTASKLABEL))_PROC-CONTENTS-2015.pdf"
        AUTHOR="Matthew C. Vanderbilt"
        TITLE="Targeting Reduced Asthma Hospitalizations"
        SUBJECT="MS Business Analytics Thesis"
        STYLE=StatDoc;
    PROC CONTENTS DATA=CHIS2015.adult VARNUM;
        ...
        %INCLUDE "&localRawDataPath.\CHIS\CHIS15_adult_sas\Data\ADULT_FORMAT.SAS";
        %INCLUDE "&localRawDataPath.\CHIS\CHIS15_adult_sas\Data\ADULT_LABEL.SAS";
    RUN;
ODS PDF CLOSE;

/* LOAD & VALIDATE 2014 DATA */
LIBNAME CHIS2014 "&localRawDataPath.\CHIS\CHIS14_adult_sas\Data\";
%INCLUDE "&localRawDataPath.\CHIS\CHIS14_adult_sas\Data\ADULT_PROC_FORMAT.SAS";
ODS PDF FILE="&localProjectPath.CHIS\%SYSFUNC(DEQUOTE(&_CLIENTTASKLABEL))_PROC-CONTENTS-2014.pdf"
        AUTHOR="Matthew C. Vanderbilt"
        TITLE="Targeting Reduced Asthma Hospitalizations"
        SUBJECT="MS Business Analytics Thesis"
        STYLE=StatDoc;
    PROC CONTENTS DATA=CHIS2014.adult VARNUM;
        ...
        %INCLUDE "&localRawDataPath.\CHIS\CHIS14_adult_sas\Data\ADULT_FORMAT.SAS";
        %INCLUDE "&localRawDataPath.\CHIS\CHIS14_adult_sas\Data\ADULT_LABEL.SAS";
    RUN;
ODS PDF CLOSE;

/* LOAD & VALIDATE 2013 DATA */
LIBNAME CHIS2013 "&localRawDataPath.\CHIS\CHIS13_adult_sas\Data\";
%INCLUDE "&localRawDataPath.\CHIS\CHIS13_adult_sas\Data\ADULT_PROC_FORMAT.SAS";
ODS PDF FILE="&localProjectPath.CHIS\%SYSFUNC(DEQUOTE(&_CLIENTTASKLABEL))_PROC-CONTENTS-2013.pdf"
        AUTHOR="Matthew C. Vanderbilt"
        TITLE="Targeting Reduced Asthma Hospitalizations"
        SUBJECT="MS Business Analytics Thesis"
        STYLE=StatDoc;
    PROC CONTENTS DATA=CHIS2013.adult VARNUM;
        ...
        %INCLUDE "&localRawDataPath.\CHIS\CHIS13_adult_sas\Data\ADULT_FORMAT.SAS";
        %INCLUDE "&localRawDataPath.\CHIS\CHIS13_adult_sas\Data\ADULT_LABEL.SAS";
    RUN;
ODS PDF CLOSE;

/* LOAD & VALIDATE 2012 DATA */
LIBNAME CHIS2012 "&localRawDataPath.\CHIS\CHIS12_adult_sas\Data\";
%INCLUDE "&localRawDataPath.\CHIS\CHIS12_adult_sas\Data\ADULT_PROC_FORMAT.SAS";
ODS PDF FILE="&localProjectPath.CHIS\%SYSFUNC(DEQUOTE(&_CLIENTTASKLABEL))_PROC-CONTENTS-2012.pdf"
        AUTHOR="Matthew C. Vanderbilt"
        TITLE="Targeting Reduced Asthma Hospitalizations"
        SUBJECT="MS Business Analytics Thesis"
        STYLE=StatDoc;
    PROC CONTENTS DATA=CHIS2012.adult VARNUM;
        ...
        %INCLUDE "&localRawDataPath.\CHIS\CHIS12_adult_sas\Data\ADULT_FORMAT.SAS";
        %INCLUDE "&localRawDataPath.\CHIS\CHIS12_adult_sas\Data\ADULT_LABEL.SAS";
    RUN;
ODS PDF CLOSE;

/* LOAD & VALIDATE 2011 DATA */
LIBNAME CHIS2011 "&localRawDataPath.\CHIS\CHIS11_adult_sas\Data\";
%INCLUDE "&localRawDataPath.\CHIS\CHIS11_adult_sas\Data\ADULT_PROC_FORMAT.SAS";
ODS PDF FILE="&localProjectPath.CHIS\%SYSFUNC(DEQUOTE(&_CLIENTTASKLABEL))_PROC-CONTENTS-2011.pdf"
        AUTHOR="Matthew C. Vanderbilt"
        TITLE="Targeting Reduced Asthma Hospitalizations"
        SUBJECT="MS Business Analytics Thesis"
        STYLE=StatDoc;
    PROC CONTENTS DATA=CHIS2011.adult VARNUM;
        ...
        %INCLUDE "&localRawDataPath.\CHIS\CHIS11_adult_sas\Data\ADULT_FORMAT.SAS";
        %INCLUDE "&localRawDataPath.\CHIS\CHIS11_adult_sas\Data\ADULT_LABEL.SAS";
    RUN;
ODS PDF CLOSE;

/* COMBINE & REWEIGHT DATA TALBES */
...
/* CHREATE MUTLI-USE CHIS FORMATS */
...
/* FORMAT CHIS SECTION A: DEMOGRAPHIC INFORMATION FORMATS */
PROC FORMAT LIBRARY=CHIS;
    VALUE fage          -1    = 'NA'
                         18   = '18-25'
                         26   = '26-29'
...
/* FORMAT CHIS SECTION B: GENERAL HEALTH CONDITION */
PROC FORMAT LIBRARY=CHIS;
...
/* FORMAT CHIS SECTION C: HEALTH BEHAVIOURS */
PROC FORMAT LIBRARY=CHIS;
    VALUE fad37w         1    = 'Yes'
                         2    = 'No'
                         3    = 'Unable to Walk'
...
/* FORMAT CHIS SECTION D: GENERAL HEALTH, DISABILITY & SEXUAL HEALTH */
PROC FORMAT LIBRARY=CHIS;
...
/* FORMAT CHIS SECTION G: DEMOGRAPHIC INFORMATION / CHILD CARE */
PROC FORMAT LIBRARY=CHIS;
...
/* FORMAT CHIS SECTION H: HEALTH INSURANCE */
PROC FORMAT LIBRARY=CHIS;
...
/* FORMAT CHIS SECTION J: HEALTH CARE UTILIZATION / ACCESS & DENTAL HEALTH */
PROC FORMAT LIBRARY=CHIS;
    VALUE    fah1z       1    = 'Yes'
                         2    = 'No'
                         3    = 'Doctor / My Doctor'
...
/* FORMAT CHIS SECTION K: EMPLOYMENT, INCOME, POVERTY STATUS & FOOD SECURITY */
PROC FORMAT LIBRARY=CHIS;
...
/* FORMAT CHIS SECTION L: PUBLIC PROGRAM PARETICIPATION */
DATA CHIS.CHIS_DATA_RAW;
    SET CHIS.CHIS_DATA_RAW;
...
/* FORMAT CHIS SECTION M: HOUSING & COMMUNITY INVOLVEMENT */
PROC FORMAT LIBRARY=CHIS;
...
/* FORMAT CHIS SECTION N: DEMOGRAPHIC INFORMATION / GEOGRAPHIC INFORMATION */
PROC FORMAT LIBRARY=CHIS;
...
/* FORMAT CHIS SECTION Q: SCREENING INFORMATION */
PROC FORMAT LIBRARY=CHIS;
