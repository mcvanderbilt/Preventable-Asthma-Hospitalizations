...
ODS PDF FILE="&localProjectPath.CHIS\%SYSFUNC(DEQUOTE(&_CLIENTTASKLABEL))_PROC-SURVEYFREQ-Demographics.pdf"
        ...
        STYLE=StatDoc;
    PROC SURVEYFREQ DATA=CHIS.CHISSEVERITY VARMETHOD=JACKKNIFE;
        TITLE 'PROC SURVEYFREQ - CHIS.CHISSEVERITY - Demographic Information';
        WEIGHT    FNWGT0;
...
ODS PDF FILE="&localProjectPath.CHIS\%SYSFUNC(DEQUOTE(&_CLIENTTASKLABEL))_PROC-SURVEYFREQ-Health.pdf"
        ...
        STYLE=StatDoc;
    PROC SURVEYFREQ DATA=CHIS.CHISSEVERITY VARMETHOD=JACKKNIFE;
        TITLE 'PROC SURVEYFREQ - CHIS.CHISSEVERITY - Health';
        WEIGHT    FNWGT0;
        REPWEIGHT FNWGT1-FNWGT160 / jkcoefs = 1;
        TABLES    (AB1
...
ODS PDF FILE="&localProjectPath.CHIS\%SYSFUNC(DEQUOTE(&_CLIENTTASKLABEL))_PROC-SURVEYFREQ-HealthInsurance.pdf"
        ...
        STYLE=StatDoc;
    PROC SURVEYFREQ DATA=CHIS.CHISSEVERITY VARMETHOD=JACKKNIFE;
        TITLE 'PROC SURVEYFREQ - CHIS.CHISSEVERITY - Health Care Access & Insurance';
        WEIGHT    FNWGT0;
        REPWEIGHT FNWGT1-FNWGT160 / jkcoefs = 1;
        TABLES    (INS
                   healthplan
...
ODS PDF FILE="&localProjectPath.CHIS\%SYSFUNC(DEQUOTE(&_CLIENTTASKLABEL))_PROC-SURVEYFREQ-Socioeconomics.pdf"
        ...
        STYLE=StatDoc;
    PROC SURVEYFREQ DATA=CHIS.CHISSEVERITY VARMETHOD=JACKKNIFE;
        TITLE 'PROC SURVEYFREQ - CHIS.CHISSEVERITY - Socioeconomic Status';
        WEIGHT    FNWGT0;
        REPWEIGHT FNWGT1-FNWGT160 / jkcoefs = 1;
        TABLES    (POVLL
                   FSLEV
...
ODS PDF FILE="&localProjectPath.CHIS\%SYSFUNC(DEQUOTE(&_CLIENTTASKLABEL))_PROC-SURVEYFREQ-Asthma.pdf"
        ...
        STYLE=StatDoc;
    PROC SURVEYFREQ DATA=CHIS.CHISSEVERITY VARMETHOD=JACKKNIFE;
        TITLE 'PROC SURVEYFREQ - CHIS.CHISSEVERITY -  Asthma Variables';
        WEIGHT    FNWGT0;
        REPWEIGHT FNWGT1-FNWGT160 / jkcoefs = 1;
        TABLES    (AB17
                   AB43
...
PROC DELETE DATA = CHIS.CHISSEVERITY;
RUN;
